        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-[#0a1628] to-[#1a2d4a] p-8 rounded-2xl border-2 border-[#c88c24] relative">
              ...
              <a href="/signup" className="block w-full px-6 py-3 bg-gradient-to-r from-[#c88c24] to-[#91682b] text-white font-semibold rounded-lg text-center hover:shadow-lg transition-all">
                Start Pro — $19/mo
              </a>
